...
const gaming_pc_header_info = {
     ...
     description:'Подберите компьютер, который подойдет для любых игр! Либо самостоятельно соберите комплектацию ПК и проверьте комплектующие на совместимость с помощью конфигуратора.',
...
const gaming_pc_categories=[
     {
          ...
          category_description:'Современные игровые компьютеры с процессорами Intel Core и видеокартами NVIDIA GeForce RTX предлагают идеальное сочетание производительности и стоимости. Максимум эффективности.',
          category_link:'/gaming-pc/optimal'
     },
     {
          category_id:'1',
          category_name:'Мощные игровые компьютеры',
          category_description:'Мощные игровые компьютеры для максимальных настроек графики в играх, на базе процессоров Intel Core и видеокарт NVIDIA GeForce RTX. Отлично подходят для киберспортивных игроков и геймеров, ценящих плавность игрового процесса с высоким FPS на максимальных графических настройках. Выбор чемпионов.',
...
const gaming_pc = [
     {
          ...
          power_supply_description:'Блок питания на 550W / 650W стандарта 80+ Bronze',
...
const GamingPcPage = () => {
     ...
     return(
          <>
               ...
               <PcCatalog categories={gaming_pc_categories} products_list={gaming_pc}/>
          </>
     )
}
