...
const PopularPcCard = ({
    ...
    return (
        <div className="popular-body">
            <div className="popular-body__img-container">
                <div className="popular-body__img-container__mark">
                    {mark !== "none" ? (
                        <span
                            className={`popular-body__img-container__mark--new mark mark-${mark}`}
                        >
                            {mark}
                        </span>
                    ) : null}
                ...
                <img
                    width="500px"
                    className="popular-body__img-container__img"
                    alt={name}
                    src={img}
                    loading="lazy"
                />
            </div>
            <div className="popular-body__buttons">
                <Link
                    href={`/gaming-pc/${link}`}
                    className="popular-body__buttons--learn-more button-gray-no-border"
                >
                    Узнать больше
                </Link>
                <Link
                    href={`/gaming-pc/${link}/config`}
                    className="popular-body__buttons--config green-circle-filled-link"
                >
                    <svg
                        width="27"
                        height="27"
            ...
            <footer className="popular-body__footer">
                <Link
                    href={`/gaming-pc/${link}`}
                    className="popular-body__footer__title h3"
                >
                    {name}
                </Link>
                <div className="popular-body__footer__description">
                    <p>{description}</p>
                </div>
                <div className="popular-body__footer__price">
                    От {min_price} BYN
                </div>
            </footer>
        </div>
